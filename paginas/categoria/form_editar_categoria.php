    ...
    <body>
        <div class="container" >
            ...
            if (isset($_POST['btnUpdate'])) {
                mysql_query("UPDATE categoria SET categoria = '" . $_POST['categoria'] . "', descricao = '" . $_POST['descricao'] . "' WHERE idcategoria = '" . $_GET['id'] . "'");
                writeMsg('update.sukses');

                //Re-Load Data from DB
                $sql = mysql_query("SELECT * FROM categoria WHERE idcategoria = '" . $_GET['id'] . "'");
                ...
                <div class="row">
                    ...
                    <form id="form_input" method="POST" class="form-group">
                        ...
                        <div class="form-group col-md-4">
                            <label control-label for="categoria">Categoria</label>  
                            <input id="nome" name="categoria" class="form-control"  type="text" value="<?php echo $data['categoria']; ?>">

                            <label control-label for="descricao">Descrição categoria</label>  

                            <input id="email" name="descricao" class="form-control" type="text" value="<?php echo $data['descricao']; ?>">
